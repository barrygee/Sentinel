...
(function buildSdrMiniPlayer() {
    ...
    const freqEl     = document.getElementById('sdr-mini-freq')!    as HTMLSpanElement;
    const modeEl     = document.getElementById('sdr-mini-mode')!    as HTMLSpanElement;
    ...
    (window as any)._SdrMiniPlayer = { tune, show, hide, updateSignalBar, setConnected };
