...
(function buildSpaceSideMenu() {
    ...
    _spaceSyncSideMenu = function () {
        [issBtn, trackBtn, footprintBtn, dnBtn].forEach(btn => {
            // Re-trigger active class sync by clicking the getActive logic
            // Buttons store their getActive in closure; re-read from controls
        });
